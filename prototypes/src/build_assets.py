...
# Both are 16:9. They fill two of E's five slots; the other three stay annotated
# and empty. NOTE: no people in either, which is what makes them usable at all.
STILLS = r"C:\Users\wyatt\source\repos\pharos-academy-site\assets\imagery"
for key, name in [("still_study", "still-study.png"), ("still_lamp", "still-lamp.png")]:
