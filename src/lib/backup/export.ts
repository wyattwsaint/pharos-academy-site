...
export const EXPORTED_TABLE_LABELS: Record<(typeof EXPORTED_TABLES)[number], string> = {
  ...
  applications:
    'Every application a family has sent — who applied, their phone number and household address, which inquiry it was filled from, what they answered about the Statement of Faith, any objection they raised, and who agreed to the Code of Conduct and the Handbook',
  application_children:
