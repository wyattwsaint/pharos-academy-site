 ...
 *
 * Still owed, each blocked on its destination page: `/giving`, `/volunteer`,
 * `/about-5` (the byte-identical duplicate of `/volunteer`, mislabelled
 * "Media"), `/calendars-and-events` and `/download-calendars`.
 *
